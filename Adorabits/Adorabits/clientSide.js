if (document.readyState == 'loading') {
  //this code is to check if the DOM is loaded if it is not some of the buttons dont work
  //as the is run but the body of the html is not loaded so there is no data
  document.addEventListener('DOMContentLoaded', ready)
  document.addEventListener('DOMContentLoaded', plushiestore)
} else {
  ready()
  plushiestore()
}
...
function plushiestore() {
  ...
  let productDuck = document.getElementById("productDuck")
